			...
			success: (function(data){
				...
				if(!data[1]['results'].length){
					...
					$.each(data[1]['results'], function(){
						...
						search_li_item += "<p><a href='admin/edit_video_entry.php?id=" + this.id + "'>Edit Video</a></p>";
						search_li_item += "<p><a href='admin/delete_video.php?id=" + this.id + "' onclick=\"return confirm('Are You Sure?')\">Delete Video</a></p>";
						//END only for admin
						search_li_item += "</li>";
